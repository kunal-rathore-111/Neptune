...
const LinkIcon = forwardRef(
  (
    { className, size = 24, onMouseEnter, onMouseLeave, ...props }: LinkIconProps,
    ...
    return (
      ...
      >
        <svg
          ...
          <motion.path d="M9 15l6 -6" initial="normal" animate={connectControls} variants={CONNECT_VARIANTS} />
        </svg>
      </motion.div>
    );
  },
