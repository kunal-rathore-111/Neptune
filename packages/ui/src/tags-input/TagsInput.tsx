...
export function TagsInputComp() {
  ...
  return (
    ...
    >
      ...
      <TagsInput.TagsInputClear className="border-input 0 flex h-9 items-center justify-center gap-2 rounded-sm border bg-transparent text-zinc-800 shadow-xs dark:text-zinc-300 dark:hover:bg-zinc-900/80">
